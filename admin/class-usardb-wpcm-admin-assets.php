...
class USARDB_WPCM_Admin_Assets extends WPCM_Admin_Assets {
    ...
    public function admin_scripts( $hook ) {
        ...
        wp_register_script( 'jquery-locationpicker', get_template_directory_uri() . '/wpclubmanager/assets/js/locationpicker.jquery.js', array( 'jquery', 'google-maps' ), '0.1.16', true );
