    ...
    <div id="wpclubmanager-fields" class="inline-edit-col">
        ...
        <div class="match_fields">
            ...
            <label class="alignleft neutral">
                ...
                <span class="checkbox-title"><?php _e( 'Neutral?', 'wp-club-manager' ); ?></span>
            </label>
            ...
            <table>
                <thead>
                    <tr>
                        <td>&nbsp;</td>
                        <th>
                            <?php _ex( 'Home', 'team', 'wp-club-manager' ); ?>
                        </th>
                        <th>
                            <?php _ex( 'Away', 'team', 'wp-club-manager' ); ?>
                        </th>
                    </tr>
                </thead>
                <tbody>
